...
## 実装更新（2026-04-13）
- エージェントテンプレートを更新し、新規の議論記録は `.dodkit/templates/discussion-record.md` から開始することを必須化しました。
- エージェントは、現在の議論向けに内容を調整する前に、そのインストール済みテンプレートを `records/{discussion-id}.md` として複製するよう明示的に指示します。
